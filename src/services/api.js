...
export const supplementApi = {
  ...
  create: (data) => request('/supplements', { method: 'POST', body: data, auth: true }),
  update: (id, data) =>
    request(`/supplements/${id}`, { method: 'PUT', body: data, auth: true }),
  remove: (id) => request(`/supplements/${id}`, { method: 'DELETE', auth: true }),
...
export const diseaseApi = {
  ...
  create: (data) => request('/diseases', { method: 'POST', body: data, auth: true }),
  update: (id, data) =>
    request(`/diseases/${id}`, { method: 'PUT', body: data, auth: true }),
  remove: (id) => request(`/diseases/${id}`, { method: 'DELETE', auth: true }),
